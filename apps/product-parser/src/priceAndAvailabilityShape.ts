...
export const priceAndAvailabilityTransform = <
  T extends z.infer<typeof priceAndAvailabilityShape>
>({
  price,
  availability_date,
  ...rest
  ...
  if (match && match.groups) {
    ...
    priceValue = match.groups.price
      ? Number(match.groups.price.replace(",", "."))
      : null;
  }
